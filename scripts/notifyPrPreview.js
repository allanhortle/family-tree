...
const region = process.env.FAMILY_TREE_AWS_S3_ENDPOINT;
const bucket = process.env.FAMILY_TREE_AWS_S3_BUCKET_NAME;
...
github.authenticate({
    type: 'oauth',
    token: process.env.FAMILY_TREE_GITHUB_API_KEY
});
